<!-- BEGIN #sidebar -->
<div id="sidebar" class="app-sidebar bg-gradient-light border-0">
    <!-- BEGIN scrollbar -->
    <div class="app-sidebar-content text-whita" data-scrollbar="true" data-height="100%">
        <!-- BEGIN menu -->
        <div class="menu">
            @php
            ...
            <div class="sidenav-footer mx-2 mt-5">
                <a class="btn bg-gradient-gray-600 btn-sm mb-0 w-100 text-white" href="#" type="button">Version 1.0.0</a>
            </div>
        </div>
        <!-- END menu -->
    </div>
